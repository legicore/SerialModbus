...
bool SerialModbusBase::setSerialCtrl( MB_Callback_f serialCtrlTx, MB_Callback_f serialCtrlRx )
{
...
/*----------------------------------------------------------------------------*/
    ...
    void SerialModbusBase::setProcessLoopHook( MB_Callback_f loopHookFunction )
    {
