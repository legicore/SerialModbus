...
public:
    ...
    void begin( uint8_t slaveId, uint32_t baud, HardwareSerial * serial = &Serial, uint8_t config = SERIAL_8E1 );
#elif defined( __AVR_ATmega32U4__ ) || defined( __AVR_ATmega16U4__ )
    void begin( uint8_t slaveId, uint32_t baud, HardwareSerial * serial = &Serial1, uint8_t config = SERIAL_8E1 );
#endif
